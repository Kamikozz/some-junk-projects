...
var fs = require('fs');
// fs.appendFile('items.log', '<DELETEMECYKABLYAT>' + xhr.responseText, function (err) {
//     if (err) {
//         console.error(err);
//         return;
//     }
...
if (xhr.status != 200) {
    ...
    // TODO: console.log('Main page parsing: DONE. Last page is "' + lastPage + '"');
    ...
    if (xhr.status != 200) {
        ...
        var timer1 = setInterval(function () {
            ...
            // TODO: console.log('Retrieving page ' + k + ' "' + url + k + '"');
            k++;
        }, timeDelayOuter);
        setTimeout(function () {
            ...
            //var reItemUrlsNamesThumbs = /.*<div class="product-item">\s*.*\s*.*\s*(?:.*Акция.*\s*)?<a href="(.*)" title="(.*)"><img src="(.*)"\s/g
            ...
            for (var i = 0; i < unparsedHtmlPages.length; i++) {
                ...
                // TODO: console.log('itemUrls (must be 12/9): ' + (itemUrls.length - temp) + ' ' + itemUrls[i] + ' ' + 'https://stroy-opt.com/catalog/?page_14=' + (i + 1));
            }
            // TODO: console.error(itemUrls);
            ...
            var timer2 = setInterval(function () {
                ...
                // TODO: console.error("Current No." + i);
                i++;
            }, timeDelay);
            setTimeout(function () {
                ...
                for (var j = 0; j < unparsedHtmlItems.length; j++) {
                    ...
                    while ((result = re.exec(unparsedHtmlItems[j])) != null) {
                        ...
                        //console.log("Matched `" + result[0] + "' " + result.index + " " + page.lastIndex);
                    }
                ...
                //console.log(photoUrl, price, ids, available, vendors, options, descriptions);
                //console.log(unparsedHtmlItems.length);
    ...
    //console.log(unparsedHtmlPages.length);
